...
import { LucideAngularModule, LucideIconNode , House , Gift , ClipboardList , PartyPopper ,Headset , Info} from 'lucide-angular';
...
export class SecondNav {
    ...
    readonly icons = [House , Gift , ClipboardList , PartyPopper , Headset , Info];
